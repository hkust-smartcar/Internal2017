...
public:
	...
	void gyro_auto_calibration();
	void gyro_calibration(float *output);  //manual-calibration
	void acc_calibration(float *output);  //manual-calibration
	void mag_calibration(float *output);  //manual-calibration

	void readAccData(float *);
...
private:
	...
	float magAdjustment[3]={0.0, 0.0, 0.0};
	float gyroCalibration[3]={0.0, 0.0, 0.0};
	...
	float moving_average_mag_x[4]={0.0,0.0,0.0,0.0};
	float moving_average_acc_x[4]={0.0,0.0,0.0,0.0};
	float moving_average_gyro_x[3]={0.0,0.0,0.0};

	float moving_average_mag_y[4]={0.0,0.0,0.0,0.0};
	float moving_average_acc_y[4]={0.0,0.0,0.0,0.0};
	float moving_average_gyro_y[3]={0.0,0.0,0.0};

	float moving_average_mag_z[4]={0.0,0.0,0.0,0.0};
	float moving_average_acc_z[4]={0.0,0.0,0.0,0.0};
	float moving_average_gyro_z[3]={0.0,0.0,0.0};
    ...
    float x_off_set_acc=0.02;
    float y_off_set_acc=0.01;
    float z_off_set_acc=0.02;

    float x_off_set_mag=262.63;  //244.00
    float y_off_set_mag=283.23;  //287.81
    float z_off_set_mag=-95.13;  //-130.18

    float x_off_set_gyro=-0.84;
    float y_off_set_gyro=-0.40;
    float z_off_set_gyro=-0.19;
	...
	Config::Bit m_magnetic_range;
	Config::M_MODE m_mode;
